...
public class RedSimpleCenter extends SequentialCommandGroup {
    

    public RedSimpleCenter(SwerveDrive swerve, Elevator elevator, Arm arm, Intake intake){
        PathValidation p1 = new PathValidation("RedSimpleCenterp1");
        PathValidation p2 = new PathValidation("RedSimpleCenterp2");
        PathValidation p3 = new PathValidation("RedSimpleCenterp3");
        PathValidation p4 = new PathValidation("RedSimpleCenterp4");
        PathValidation p5 = new PathValidation("RedSimpleCenterp5");
